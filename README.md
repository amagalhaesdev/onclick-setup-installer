...
🇧🇷  
Sempre que eu precisava resetar ou formatar o Windows, eu perdia muito tempo baixando e instalando um por um todos os programas que uso no dia a dia.  
Para resolver isso, criei o **OnClick Setup**: um instalador automatizado com menu interativo que usa o **Windows Package Manager (WinGet)**.  
